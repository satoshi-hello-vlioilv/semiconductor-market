...
const COMPANIES=[
  ...
  {id:'oxide',layer:1,sub:'特殊材料',name:'オキサイド',en:'Oxide Inc.',ticker:'6521.T',country:'JP',
   ...
   featured:true,gnt:true,revenue:'≈¥30億',mcap:'≈¥100億規模',stock24:'年初来高値¥7,420→AI投資ピークアウト懸念で急落',perf:'dn',
  ...
  // ─── GNT追加（ガラス・土石／AI半導体基板材料） ───
  {id:'nittobo',layer:1,sub:'ガラス・基板材料',name:'日東紡績',en:'Nitto Boseki',ticker:'3110.T',country:'JP',
   product:'半導体パッケージ基板用 低誘電ガラスクロス（Tガラス・NTガラス）',share:85,shareLabel:'低誘電ガラスクロス（世界シェア8割超）',
   featured:true,gnt:true,revenue:'¥1,182億（FY26/3・+8.4%）',mcap:'≈¥6,375億',stock24:'上場来高値圏（2026年7月に1:5株式分割）',perf:'up',
   ir:{per:'—',pbr:'—',roe:'—',div:'¥28（分割後換算）',guidance:'電子材料事業の増収増益が牽引',latestQ:'FY26/3営業利益¥208億（+26.6%・過去最高）',irLink:'https://www.nittobo.co.jp/ir/'},
   strength:'半導体パッケージ基板（ABF基板等）に不可欠な特殊ガラス繊維「Tガラス」（高弾性・低熱膨張）と「NTガラス」（低誘電・低誘電正接）で世界シェアを実質独占。日経ヴェリタスは「特殊ガラス繊維は世界シェア9割超」と報道。AIサーバーの伝送高速化（800Gbps→1.6Tbps）が高性能ガラスクロス需要を牽引し、2026年に入り上場来高値圏で推移。急拡大する需要を受け2026年7月に1株を5株にする株式分割を実施し投資家層を拡大。',
   risk:'日本電気硝子が新型「D2ファイバ」で対抗し独占構造に挑戦中。旭化成など新規参入の動きもあり長期的な独占度は流動的。電子材料事業への依存度上昇。',
   outlook:'AI半導体パッケージ基板の需給逼迫を背景に価格改定・供給争奪戦が報じられており、収益性のさらなる向上余地がある。',
   highlights:['低誘電ガラスクロス世界シェア8割超','AI/HPC基板の必須素材','2026年7月に1:5株式分割'],
  },
  {id:'maruwa',layer:1,sub:'ガラス・基板材料',name:'MARUWA',en:'Maruwa Co., Ltd.',ticker:'5344.T',country:'JP',
   product:'窒化アルミ（AlN）セラミック基板',share:90,shareLabel:'AlNセラミック基板（世界シェア約9割）',
   featured:true,gnt:true,revenue:'営業利益率33.5%（FY26/3実績）',mcap:'≈¥7,371億',stock24:'決算失望で急落（7/7 -12.79%）',perf:'dn',
   ir:{per:'—',pbr:'—',roe:'—',div:'—',guidance:'FY27/3営業益+19%見通し（市場コンセンサス未達）',latestQ:'FY26/3実績：営業利益率33.5%（業界屈指の高収益）',irLink:'https://www.maruwa-g.com/ir/'},
   strength:'パワー半導体・高周波部品の放熱基板として使われる窒化アルミニウム（AlN）セラミック基板で世界シェア約9割を握るファインセラミックス大手。FY26/3実績で営業利益率33.5%という業界屈指の高収益体質を誇る。',
   risk:'2026年7月7日、今期（FY27/3）営業利益+19%の会社計画が市場コンセンサスを下回ったとして株価が1日で-12.79%急落。高い期待値ゆえの株価変動リスクが大きい。',
   outlook:'汎用メモリ需要の下期本格拡大、AI/パワー半導体向け放熱基板需要の中長期拡大が期待される一方、短期的な期待値超えのハードルは高い。',
   highlights:['AlN基板世界シェア約9割','営業利益率33.5%（業界屈指）','7/7決算ガイダンス未達で急落'],
  },
  {id:'agc',layer:1,sub:'ガラス・基板材料',name:'AGC',en:'AGC Inc.',ticker:'5201.T',country:'JP',
   product:'半導体パッケージ用ガラスコア基板（無アルカリガラス）',
   featured:true,revenue:'総合ガラス世界最大手',mcap:'≈¥1.4兆（2026年7月時点）',stock24:'堅調',perf:'up',
   ir:{per:'—',pbr:'—',roe:'—',div:'—',guidance:'ガラスコア基板の量産化に向け開発投資継続',latestQ:'—',irLink:'https://www.agc.com/ir/'},
   strength:'世界最大級のガラスメーカー。無アルカリガラスを用い、シリコンとCTE（熱膨張係数）を完全一致させた平坦・平滑なガラスコア基板（500mm角パネルまたは300mm径ウェーハ形状）を製品化。板ガラス・ディスプレイガラスで培った大型・高品質量産技術が強み。',
   risk:'ガラスコア基板はまだ量産初期段階で、日本電気硝子・TOPPAN・SKC Absolicsなどとの規格争いが継続中。半導体材料事業の利益貢献度は全社総合ガラス事業の中では相対的に小さい。',
   outlook:'Intel・TSMC・AMDなど大手が次世代パッケージでガラスコア採用を検討しており、2020年代後半の量産本格化が見込まれる。',
   highlights:['ガラスコア基板（無アルカリガラス）','CTEをシリコンに完全一致','次世代AI半導体パッケージの本命候補'],
  },
  {id:'neg',layer:1,sub:'ガラス・基板材料',name:'日本電気硝子',en:'Nippon Electric Glass',ticker:'5214.T',country:'JP',
   product:'低誘電ガラスファイバ「D2ファイバ」・無機コア基板「GCコア」',
   featured:true,revenue:'特殊ガラス大手',mcap:'≈¥5,404億（2026年7月時点）',stock24:'荒い値動き（7/7 -4.48%）',perf:'dn',
   ir:{per:'—',pbr:'—',roe:'—',div:'—',guidance:'複合材料事業の構造改革を継続中',latestQ:'—',irLink:'https://www.neg.co.jp/ir/'},
   strength:'2025年12月発売の低誘電ガラスファイバ「D2ファイバ」は誘電正接0.0017（@10GHz・自社調べ世界最小級）を実現し、日東紡が事実上独占してきた市場に本格参入。オーバーフロー法による極薄・高品質ガラス製造技術を核に、厚さ0.025mmの無機コア基板「GCコア」（大型パネル対応）も開発し次世代AI半導体パッケージ基板で存在感を高めている。',
   risk:'複合材料事業の構造改革中（一部生産停止・移管）で収益性にばらつき。日東紡という強力な先行者との顧客獲得競争が続く。',
   outlook:'AIサーバー通信速度の高速化（800Gbps→1.6Tbps）で低誘電ガラス素材需要が構造的に拡大。GCコアの量産採用が進めば新たな収益柱となる可能性。',
   highlights:['低誘電ガラスファイバ「D2ファイバ」','無機コア基板「GCコア」開発','日東紡の牙城に本格参入'],
  },
  ...
  {id:'asml',layer:2,sub:'リソグラフィ',name:'ASML',en:'ASML Holding N.V.',ticker:'ASML',country:'NL',
   ...
   featured:true,gnt:true,
   revenue:'€32.5B（2025・+約15%）',mcap:'≈€600B規模',stock24:'+約100%（直近1年）',perf:'up',
  ...
  {id:'tel',layer:2,sub:'プロセス装置',name:'東京エレクトロン（TEL）',en:'Tokyo Electron',ticker:'8035.T',country:'JP',
   ...
   featured:true,gnt:true,
   revenue:'≈¥2兆',mcap:'≈¥32兆',stock24:'+約70%（直近1年）',perf:'up',
  ...
  {id:'amat',layer:2,sub:'プロセス装置',name:'Applied Materials',en:'AMAT',ticker:'AMAT',country:'US',
   ...
   revenue:'$27.2B',mcap:'≈$440B規模',stock24:'+約190%（直近1年）',perf:'up',
  ...
  {id:'lam',layer:2,sub:'プロセス装置',name:'Lam Research',ticker:'LRCX',country:'US',
   ...
   revenue:'$14.9B',mcap:'≈$470B規模',stock24:'+約200%（直近1年）',perf:'up',
  ...
  {id:'kla',layer:2,sub:'プロセス装置',name:'KLA',ticker:'KLAC',country:'US',
   ...
   revenue:'$9.5B',mcap:'≈$310B規模',stock24:'+約120%（直近1年・10:1分割実施）',perf:'up',
  ...
  {id:'lasertec',layer:2,sub:'プロセス装置',name:'レーザーテック',en:'Lasertec Corporation',ticker:'6920.T',country:'JP',
   ...
   featured:true,gnt:true,
   revenue:'≈¥1,800億',mcap:'≈¥3.5兆',stock24:'+約25%（直近1年）',perf:'up',
  ...
  {id:'disco',layer:2,sub:'後工程装置',name:'ディスコ（Disco）',en:'Disco Corporation',ticker:'6146.T',country:'JP',
   ...
   featured:true,gnt:true,
   revenue:'≈¥3,000億',mcap:'≈¥8.6兆',stock24:'+約130%（直近1年）',perf:'up',
  ...
  {id:'advantest',layer:2,sub:'後工程装置',name:'アドバンテスト',en:'Advantest Corporation',ticker:'6857.T',country:'JP',
   ...
   featured:true,gnt:true,
   revenue:'過去最高更新（FY2025）',mcap:'≈¥20兆規模',stock24:'+約60%（直近1年）',perf:'up',
  ...
  {id:'arm',layer:3,sub:'CPU IPコア',name:'ARM Holdings',en:'Arm Holdings plc',ticker:'ARM',country:'UK',
   ...
   featured:true,
   revenue:'$4.92B（FY2026・+23%）',mcap:'≈$320B規模（2026年7月調整後）',stock24:'7月に急落（AI投資ピークアウト懸念）',perf:'dn',
  ...
  {id:'nvidia',layer:4,sub:'AI / HPC',name:'NVIDIA',ticker:'NVDA',country:'US',
   ...
   featured:true,
   revenue:'$215.9B（FY2026・+65%）',mcap:'≈$5.05T（世界首位）',stock24:'+約30%（直近1年）',perf:'up',
  ...
  {id:'broadcom',layer:4,sub:'ASIC / ネットワーク',name:'Broadcom',ticker:'AVGO',country:'US',
   ...
   revenue:'≈$60B（FY2025）',mcap:'≈$1.8兆ドル規模',stock24:'+約55%（直近1年）',perf:'up',
  ...
  {id:'skhynix',layer:5,sub:'メモリIDM',name:'SK hynix',ticker:'000660.KS',country:'KR',
   ...
   featured:true,
   revenue:'$44.2B（2024）→過去最高（2025）',mcap:'≈$1兆ドル前後',stock24:'2026年7月NASDAQ ADR上場（$26.5B調達）・国内株は調整',perf:'dn',
   ...
   highlights:['HBM世界1位（62%・断トツ）','HBM4量産開始（2026年2月）・Rubin向け','2026年7月NASDAQ ADR上場（$26.5B調達）'],
  },
  ...
  {id:'micron',layer:5,sub:'メモリIDM',name:'Micron Technology',ticker:'MU',country:'US',
   ...
   revenue:'$37.4B（FY2025・過去最高）',mcap:'≈$1.1兆ドル規模',stock24:'+約800%（直近1年）',perf:'up',
  ...
  {id:'kioxia',layer:5,sub:'メモリIDM',name:'キオクシア（Kioxia）',en:'Kioxia Holdings',ticker:'285A.T',country:'JP',
   product:'3D NAND（BiCS FLASH）',share:14,shareLabel:'NAND世界シェア（3位）',
   featured:true,
   revenue:'≈¥3兆（FY2025・過去最高）',mcap:'≈¥36兆規模（2026年7月調整後）',stock24:'上場来なお数十倍圏も7月は急落',perf:'dn',
   ir:{per:'20x',pbr:'4.5x',roe:'22%',div:'¥30',guidance:'NANDスーパーサイクルで価格・数量とも拡大',latestQ:'1〜3月売上¥1兆超（+189%）・営業益15倍の過去最高益',irLink:'https://www.kioxia-holdings.com/ja-jp/ir/'},
   strength:'2024年12月東証プライム上場（証券コード285A）。NANDシェア世界3位（14%）。AIメモリ・スーパーサイクルでNAND価格が歴史的に高騰し、株価は上場来約56倍・年初来+660%に急騰、時価総額でトヨタに迫る日本最大級の企業に。2026年の生産能力は実質完売。四日市・北上工場でBiCS NAND最先端を生産。',
   highlights:['上場来 約56倍・年初来+660%','NAND世界3位（14%）・2026年完売','時価総額 日本最大級（トヨタ級）'],
  },
...
/* ─── Build Stock Ranking ─── */
const STOCK_RANKING=[
  {rank:1,id:'oxide',name:'オキサイド',ticker:'6521.T',country:'JP',currRef:'¥4,355前後',tgtRef:'¥22,500',multi:5.2,horizon:'18ヶ月',moat:'DUV波長変換単結晶95%独占',catalysts:['AI検査装置需要の急増','EUV光源コンポーネント展開','KLA・日立ハイテク採用継続'],rationale:'時価総額≈¥150億という極めて小さな規模に対し、代替品ゼロの95%独占という構造的優位性が非対称リターンを生む。売上¥30億規模のため微細化進展に伴う受注増が利益に直結。AI GPU量産増で検査装置需要は構造的拡大局面にあり、小型株特有の営業レバレッジが最大の魅力。',risk:'流動性が低く機関投資家の参入が制限される。半導体サイクル感応が高い。2026年5月の年初来高値¥7,420からAI投資ピークアウト懸念で急落しており、値動きの荒さに注意。'},
  {rank:2,id:'advantest',name:'アドバンテスト',ticker:'6857.T',country:'JP',currRef:'¥29,830前後',tgtRef:'¥35,000',multi:1.2,horizon:'18ヶ月',moat:'AI GPUテスタ事実上独占',catalysts:['Rubin世代でテスト時間3〜4倍化','HBM4テスト需要加速','生産能力5,000→10,000台倍増'],rationale:'NVIDIAのBlackwell→Rubinへの移行でテスト難易度が非線形に増加。H100→B200でテスト時間2〜3倍、Rubin→HBM4でさらに倍増が見込まれる。FY2026/3期は売上¥1兆1,286億（+44.7%）・営業利益¥4,991億（+118.8%）と過去最高を更新。Installed Baseのストック収益も積み上がり中。',risk:'NVIDIA依存度70%超でAIバブル崩壊時のリスク高。高バリュエーション継続中。'},
  {rank:3,id:'lasertec',name:'レーザーテック',ticker:'6920.T',country:'JP',currRef:'¥44,380前後',tgtRef:'¥58,000',multi:1.3,horizon:'18ヶ月',moat:'EUVマスク検査装置100%独占',catalysts:['High-NA EUV普及で装置単価上昇','Rapidus千歳ファブ稼働','Samsung 2nm GAA量産開始'],rationale:'ASML EUVを1台導入するたびにレーザーテック装置も1台必要という連動構造は不変。High-NA EUV（NA=0.55）移行でマスクの複雑性が急増し、検査精度要求と単価が上昇。Rapidus国内顧客追加でリスク分散も進む。',risk:'ピーク時に比べバリュエーション調整は進行済みだが、TSMC設備投資サイクルに依存。'},
  {rank:4,id:'broadcom',name:'Broadcom',ticker:'AVGO',country:'US',currRef:'$384前後',tgtRef:'$650',multi:1.7,horizon:'18ヶ月',moat:'ハイパースケーラXPU設計独占',catalysts:['推論AI需要でカスタムXPU急成長','OpenAI $10B ASIC契約','Google/Meta/Apple全顧客化'],rationale:'AI推論フェーズ移行でカスタムASIC（XPU）の経済合理性が高まりNVIDIA依存分散が加速。Google・Meta・Apple・OpenAIという最大クラウド4社が全てBroadcom顧客。NVIDIA独占に対するヘッジとして大規模発注継続。時価総額$1Tから$2Tへの道筋が見える。',risk:'TSMCの先端製造容量確保が課題。VMwareソフト事業との統合消化が続く。'},
  {rank:5,id:'skhynix',name:'SK hynix',ticker:'000660.KS',country:'KR',currRef:'₩1,845,000前後',tgtRef:'₩3,010,000',multi:1.6,horizon:'18ヶ月',moat:'HBM世界シェア62%（断トツ1位）',catalysts:['HBM4（Rubin向け）独占的供給','AIメモリ・スーパーサイクル継続','Cheongju新工場$12.9B稼働（2028）'],rationale:'HBM3E/HBM4でNVIDIA向け供給を主導し、2026年に時価総額$1兆ドルを突破、世界で最も収益性の高いメモリ企業に。2026年7月にNASDAQへADR上場（SKHY、$26.5B調達）し米国投資家層を拡大。AIメモリ・スーパーサイクルでHBM供給能力の希少性がプレミアムを正当化する一方、AI投資ピークアウト懸念で7月に株価は調整。',risk:'NVIDIA依存度が高く、AI需要が反転した際の在庫・価格リスク。Samsung・Micronの追走。ADR上場に伴う需給変化。'},
  {rank:6,id:'arm',name:'ARM Holdings',ticker:'ARM',country:'UK',currRef:'$300前後',tgtRef:'$565',multi:1.9,horizon:'18ヶ月',moat:'モバイルSoC 99%採用・データセンターCPU侵食',catalysts:['データセンターCPUでx86シェア25%超へ','ロイヤリティ単価上昇（高価値チップ増）','Qualcomm訴訟完全勝訴で事業リスク消滅'],rationale:'AWS Graviton4・Google Axion2・Microsoft Cobalt2など大手クラウドがARMサーバーCPUを積極採用しx86依存度を引き下げ中。ARMのロイヤリティ収入はチップ価格に連動するため、高価値AI SoCの増加で平均単価（ARP）が上昇する構造。2026年7月はAI投資ピークアウト懸念・高バリュエーション警戒で株価が大きく調整（1ヶ月で約2割下落）。',risk:'RISC-Vの中国政策採用と国産化圧力。成長期待の高バリュエーションゆえ調整局面での下落幅も大きい。'},
  {rank:7,id:'nvidia',name:'NVIDIA',ticker:'NVDA',country:'US',currRef:'$208前後',tgtRef:'$308',multi:1.5,horizon:'18ヶ月',moat:'AIアクセラレータ80〜90%独占・CUDAの壁',catalysts:['Vera Rubin（2026後半）立ち上げ','データセンター支出$500B超へ','CUDAエコシステムの拡張'],rationale:'$5兆ドル時価総額・世界首位に到達後も、Vera Rubin世代でGPU性能が再び大幅向上。CUDAのスイッチングコストはむしろ高まり離脱が困難な状況が続く。FY2026データセンター売上$193.7B（過去最高）からさらなる拡大が見込まれる。',risk:'カスタムASIC（Broadcom/Marvell）が推論用途でシェア侵食。中国輸出規制の影響継続。'},
  {rank:8,id:'kioxia',name:'キオクシア',ticker:'285A.T',country:'JP',currRef:'¥67,100前後',tgtRef:'¥122,000',multi:1.8,horizon:'18ヶ月',moat:'NAND世界3位・BiCS FLASH技術',catalysts:['AIメモリ・スーパーサイクルでNAND急騰','2026年の生産能力は実質完売','AI向けeSSD需要の構造的拡大'],rationale:'2024年12月上場後、AIメモリ・スーパーサイクルでNAND価格が歴史的に高騰し株価は上場来数十倍に急騰したが、2026年7月にはAIインフラ投資ピークアウト懸念（Meta等の設備投資計画観測）とApple社の中国メモリ調達検討報道を受け、1ヶ月で¥8万円台から¥6万円台へ急落。2026年の生産能力は実質完売で、AI向けストレージ需要の構造的拡大自体は継続している。',risk:'NAND価格サイクルの反転リスク。急騰の反動による高いボラティリティ。次回決算は2026年7月31日予定。'},
  {rank:9,id:'tsmc',name:'TSMC',ticker:'TSM',country:'TW',currRef:'$434前後（ADR）',tgtRef:'$595',multi:1.4,horizon:'18ヶ月',moat:'先端ロジック≤3nm 90%超独占',catalysts:['N2量産2025年Q4始動→2026加速','Arizona複数ファブ稼働','CoWoS生産能力拡大継続'],rationale:'AI半導体需要の最終受益者として最も確実な成長軌道上にある。N2量産・CoWoS拡張・地理的分散の三本柱が揃い、台湾地政学リスクのディスカウントが縮小傾向。NVIDIA最大顧客化でトップライン成長が加速。',risk:'台湾有事リスクは依然として株価のキャップ要因。CapEx負担の継続。'},
  {rank:10,id:'disco',name:'ディスコ',ticker:'6146.T',country:'JP',currRef:'¥76,590前後',tgtRef:'¥112,000',multi:1.5,horizon:'18ヶ月',moat:'ダイシング装置世界70%独占',catalysts:['HBM積層でTSV工程需要急増','CoWoS対応ダイシング好調','AIサーバー1台あたりGPU数増加'],rationale:'HBMの3D積層（HBM4は16層以上）で1チップあたりのダイシング・グラインディング工程数が増加。AIサーバー1台に搭載されるHBMの量が増えることで装置需要が非線形に拡大。',risk:'HBM需要の変動感応。高バリュエーション時期もある。'},
  {rank:11,id:'asml',name:'ASML',ticker:'ASML',country:'NL',currRef:'$1,797前後',tgtRef:'$2,600',multi:1.4,horizon:'18ヶ月',moat:'EUV露光装置100%独占',catalysts:['High-NA EUV（NXE:5000）普及加速','中国規制の株価影響ほぼ織り込み済み','2030年まで受注残積み上がり'],rationale:'中国向けDUV輸出規制による売上影響はほぼ株価に織り込まれた状況。High-NA EUVの量産採用（TSMC、Samsung）が進み1台800億円超の装置が出荷される。TSMCの世界3拠点展開で需要の地理的分散も実現。',risk:'中国規制の追加強化リスク。Nikon ArF新世代機による部分的競合（2028年以降）。'},
  {rank:12,id:'amat',name:'Applied Materials',ticker:'AMAT',country:'US',currRef:'$586前後',tgtRef:'$800',multi:1.4,horizon:'18ヶ月',moat:'WFE装置売上世界1位・CMP60%独占',catalysts:['ハイブリッドボンディング（HBM先進パッケージ）参入','Gate-All-Around移行で成膜装置需要増','AI需要でWFE市場$120B超へ'],rationale:'装置売上世界1位としてWFE市場全体の拡大から恩恵。BESIへの出資でハイブリッドボンディングという高成長新市場にも布石。GAA（Gate-All-Around）移行でAMATの得意とする精密成膜・エッチング需要が増加。',risk:'中国向け規制で一部装置の輸出制限。装置サイクルの影響。'},
  {rank:13,id:'micron',name:'Micron Technology',ticker:'MU',country:'US',currRef:'$983前後',tgtRef:'$1,386',multi:1.4,horizon:'18ヶ月',moat:'HBM急拡大（21%・Samsung超え）',catalysts:['HBM3E/HBM4をBlackwell/Rubin向け採用','広島ファブ稼働でHBM生産能力拡大','メモリ・スーパーサイクルで価格急騰'],rationale:'HBM市場でSamsungを追い抜き2位に浮上。FY2025は過去最高売上$37.4Bを記録し、メモリ・スーパーサイクルで売上・粗利率とも過去最高を更新中。広島工場が日本政府補助付きで稼働し固定費を抑制。',risk:'Samsungが品質問題を解決した場合の競争激化。メモリサイクルの反転リスク。'},
  {rank:14,id:'shinetsu',name:'信越化学工業',ticker:'4063.T',country:'JP',currRef:'¥7,436前後',tgtRef:'¥9,250',multi:1.25,horizon:'18ヶ月',moat:'Siウェーハ世界1位（30%）・EUVレジスト',catalysts:['Rapidus/JASM稼働でウェーハ需要増','EUVフォトレジスト展開拡大','PVC・半導体材料の多重独占'],rationale:'ウェーハとEUVレジストの両方を供給できる唯一の企業として構造的に安定。Rapidus・JASM（TSMC熊本）・Micron広島の稼働でウェーハ需要が拡大。高い安定性と配当魅力を持つ防衛的優良株。',risk:'ウェーハサイクルでのASP下落リスク。南海トラフ地震への工場集中リスク。'},
  {rank:15,id:'lam',name:'Lam Research',ticker:'LRCX',country:'US',currRef:'$350前後',tgtRef:'$514',multi:1.5,horizon:'18ヶ月',moat:'エッチング装置世界45%独占',catalysts:['HBM TSVエッチング需要増','3D NAND積層数増加（200層超へ）','GAA移行でエッチング工程数増加'],rationale:'HBM3→HBM4移行で積層枚数が増えTSV（シリコン貫通電極）工程のエッチング需要が増加。3D NANDの更なる高積層化（200〜300層）も同社装置が必須。WFE市場拡大と相まって安定した成長基盤。',risk:'中国向け規制で一部装置の輸出制限。装置サイクル感応。'},
];
